    ...
    await getRetailersIds().then(async result => {
        ...
        result.find(item => {
            if (item.name === 'Ashario - Centrepoint Mall') {
                let store_centre_point_mall = {
                    name: item.name, id: item.id, menuTypes: item.menuTypes, address: item.address
                }
        ...
        response.then(result => {
            ...
            let cart_centre_point_mall = {
                id: result.id, items: result.items, pricingType: result.pricingType, redirectUrl: result.redirectUrl
            };
        ...
        count_Products.then(async (c) => {
            ...
            noUiSlider.create(slider_thc, {
                start: [0, 36], behaviour: 'snap', step: 1, connect: true, format: wNumb({
                    decimals: 0
                }), range: {
                    min: 0, max: 36
                }
            ...
            noUiSlider.create(slider_cbd, {
                start: [0, 16], behaviour: 'snap', step: 1, connect: true, format: wNumb({
                    decimals: 0
                }), range: {
                    min: 0, max: 16
                }
                        ...
                        <div class="card-body">
                            <div class="product-info">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="d-flex">
                                        <span style="margin-left: 5px; font-weight: bold;">THC</span>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="d-flex">
                                        <span style="margin-left: 5px; font-weight: bold;">CBD</span>
